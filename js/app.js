...
<div className="m-auto-ns f4 f3-m f2-l tc w-80-l normal">
    ...
    <div>
    From <Highlight color="blue">museums</Highlight> and <Highlight color="blue">galleries</Highlight>, to <Highlight color="pink">Robot Restaurants</Highlight> and <Highlight color="pink">kitten cafes</Highlight>, Tokyo is the gift that keeps on giving. Dattebayo! 
    </div>
</div>
);
...
const App = () => (
    <div>
      ...
      <div className="flex flex-wrap container">{attractions.map(attraction => (
